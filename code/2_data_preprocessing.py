...
a = test[(test['Pclass'] == 3) & (test['Embarked'] == 'S')]
fare_median = np.median(a[a['Fare'].notnull()]['Fare'])
test['Fare'][152] = fare_median

#%% preprocess titanic data

# titanic_X, titanic_y 데이터 생성
...
Miss_list = ['Countess', 'Lady', 'Mlle', 'Mme', 'Ms']
...
age_isnull_y = age_isnull.iloc[:, 0]
